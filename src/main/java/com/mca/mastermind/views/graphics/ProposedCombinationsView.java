...
class ProposedCombinationsView extends JPanel {
    ...
    void add(ProposalController proposalController) {
        ...
        this.add(new AttemptsView(attempts),
                new Constraints(0, attempts, 1, 1));
        this.add(new ProposedCombinationView(proposalController),
                new Constraints(1, attempts, 1, 1));
        this.add(new ResultView(proposalController),
                new Constraints(2, attempts, 1, 1));
    }
}
